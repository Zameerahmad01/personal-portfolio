        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card_data">
                zameerahmad4877@gmail.com
              </span>
              ...
              >
                write me
                <i className="bx bx-right-arrow-alt contact__info-button-icon"></i>
              </a>
            </div>
            ...
            <div className="contact__card">
              ...
              <a
                target="_blank"
                href="https://api.whatsapp.com/send?phone=+923096476328&text=Hello, more information!"
                className="contact__info-button"
              >
                write me
                <i className="bx bx-right-arrow-alt contact__info-button-icon"></i>
